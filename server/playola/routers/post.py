...
from playola.database import comment_table, database, like_table, post_table
from playola.models.post import (
    Comment,
    CommentIn,
    PostLike,
    PostLikeIn,
...
from playola.models.user import User
from playola.security import get_current_user
from playola.tasks import generate_and_add_to_post
